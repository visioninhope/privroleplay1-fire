...
At ThetaSpaces2, we recognize the power of AI and are committed to using it responsibly. We have clear rules to protect children, respect people's privacy, and prevent harmful or illegal content.
...
## Content Policies
 ...
 ThetaSpaces1 is committed to creating a safe, inclusive, and respectful environment for everyone. We are dedicated to harnessing the potential of AI responsibly, prioritizing the safety and wellbeing of minors and identifiable individuals. This content rule is inspired by [CivitAI](https://civitai.com/safety).
...
**A:** Great point, but here's the distinction. Those individuals consented to being filmed and depicted in certain ways. Here on ThetaSpaces1, we want to ensure we respect everyone's consent, regardless of their profession.
...
**A:** We care a lot about the rights of individuals and the use of their likeness. If you find an image thats depicting your likeness you can request to have removed by emailing us at help@ThetaSpaces2.
...
Remember, these guidelines are here to make sure that ThetaSpaces1 remains an innovative, respectful, and constructive community. With your cooperation and input, we can continue to make this community a shining example of how AI can be harnessed responsibly and creatively.
